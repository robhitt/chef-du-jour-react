      ...
      <div>
        ...
        <div className="container-fluid">
          ...
          <span className="button-seperator">
            <Link to={"/user_edit"}><button type="button" className="btn btn-outline-primary btn-lg active">Edit Profile</button></Link>
          </span>

          <span className="button-seperator">
            <Link to={"/user_edit"}><button type="button" className="btn btn-outline-primary btn-lg active">Delete Profile</button></Link>
          </span>
